    ...
    return (
        <SafeAreaView style={{}}>
            ...
            <Modal visible={formListModal} presentationStyle="pageSheet"
                ...
                <FormListModal setFormListModal={setFormListModal} isVisible={formListModal} navigation={props.navigation} />
            </Modal>
            <Modal visible={profileModal} animationType="slide">
                <ProfileModal user={useContext(LoggedInUserContext)} setProfileModal={setProfileModal} editable={true} />
            </Modal>
        </SafeAreaView >
    );
}