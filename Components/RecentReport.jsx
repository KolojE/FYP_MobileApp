...
{
return(
    <TouchableOpacity style={{height:45,borderBottomWidth:0.2,borderColor:"grey",borderStyle:"dotted",justifyContent:"center"}}>
<View style={{flexDirection:"row"}}>
    <View style={{justifyContent:"center",flex:1}}>
        <Text style={{fontSize:12,color:"#00000"}}>#R0152141</Text>
        <Text style={{fontSize:8,color:"#828282"}}>10 jan 2022 21:32</Text>
    </View>
